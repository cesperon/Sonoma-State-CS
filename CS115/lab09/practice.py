...
def is_magic_square(matrix):
    ...
    # Otherwise, proceed.
    for i in range (len(matrix)):
        sum_of_each_row = sum_row_values(matrix, i)
    ...
    # Otherwise, proceed.
    for i in range (len(matrix)):
        sum_of_each_column= sum_col_values(matrix, i)
...
def main():
    ...
    if square_size % 2 == 0:
        ...
        for i in range (len(matrix)):
            sum_of_row = sum_row_values(matrix, i)


        for i in range (len(matrix)):
            sum_of_col=sum_col_values(matrix, i)
