...
int main(int argc, const char * argv[]) {
  ...
  uint pixel;
  cin >> pixel; // std::hex allows us to read in a hex value
  ...
  cout <<hex<< int(red) << " of 255 red" << endl;
  cout <<hex<< int(green) << " of 255 green" << endl;
  cout <<hex<< int(blue) << " of 255 blue" << endl;
  cout <<hex<< int(alpha) << " of 255 alpha" << endl;
  cout<< hex<< int(redChannel);
  return 0;
}
