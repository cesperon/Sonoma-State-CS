...
int IntTest ()
{
  ...
  cout<<"Generating random OrderedSet with integer values."<<endl;
  ...
  cout<< "Outputting the intersection of the two ordered sets."<<endl;

  cout<< S*L<<endl<<endl;

  cout<< "Outputting the union of the two ordered sets."<<endl;

  cout << S + L <<endl<<endl;

  cout<<"That concludes integer test"<<endl<<endl;
...
void StringTest (string file)
{
  ...
  for (itr = WD.rbegin(); itr != WD.rend(); --itr)
    cout <<'\t' <<*itr <<endl;
  cout << "End of OrderedSet with string test\n\n";
